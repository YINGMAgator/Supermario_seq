...
#            print("Process {}. Episode {}".format(index, curr_episode),done)
        ...
        if curr_episode%opt.log_interval==0:
            Num_interact.append(num_interact)
...
#                time.sleep(1)  
            ...
            if info['x_pos']>opt.final_step:
                done = True
            if done:
                Num_interact1.append(num_interact)
                Cum_reward.append(round(cum_reward,2))
                X.append(info['x_pos'])
                Episode1.append(curr_episode)
                cum_reward=0
...
#            print('aaaaaaaaaaa',X,Cum_reward)
            if opt.game=='Supermario':  
                np.save(saved_path+"/X1_{}".format(index)+"nums_"+str(opt.num_sequence), X1)
                np.save(saved_path+"/X2_{}".format(index)+"nums_"+str(opt.num_sequence), X2)
                np.save(saved_path+"/X3_{}".format(index)+"nums_"+str(opt.num_sequence), X3)
                                  
#            np.save(saved_path+"/loss{}".format(index), loss_matrix)
            np.save(saved_path+"/Cum_reward1_{}".format(index)+"nums_"+str(opt.num_sequence), Cum_reward1)
#            np.save(saved_path+"/SCORE1{}".format(index), SCORE1)
#            np.save(saved_path+"/Num_interaction1{}".format(index), Num_interaction1)

            np.save(saved_path+"/Cum_reward2_{}".format(index)+"nums_"+str(opt.num_sequence), Cum_reward2)
#            np.save(saved_path+"/SCORE2{}".format(index), SCORE2)
#            np.save(saved_path+"/Num_interaction2{}".format(index), Num_interaction2)

            np.save(saved_path+"/Cum_reward3_{}".format(index)+"nums_"+str(opt.num_sequence), Cum_reward3)
#            np.save(saved_path+"/SCORE3{}".format(index), SCORE3)
#            np.save(saved_path+"/Num_interaction3{}".format(index), Num_interaction3)           
            np.save(saved_path+"/Num_interact_{}".format(index)+"nums_"+str(opt.num_sequence), Num_interact)
            np.save(saved_path+"/Episode_{}".format(index)+"nums_"+str(opt.num_sequence), Episode)
#        if curr_episode%opt.save_interval_train==0:
            np.save(saved_path+"/Num_interact1_{}".format(index)+"nums_"+str(opt.num_sequence), Num_interact1)
            np.save(saved_path+"/Cum_reward_{}".format(index)+"nums_"+str(opt.num_sequence), Cum_reward)
            np.save(saved_path+"/X_{}".format(index)+"nums_"+str(opt.num_sequence), X)
            np.save(saved_path+"/Episode1_{}".format(index)+"nums_"+str(opt.num_sequence), Episode1)
#            print('index',index,'Episode',Episode)
#            print('distance',X)
#            print('Cum_reward',Cum_reward)
#            print('Num_interact',Num_interact1)
            print(index,"curr_episode",curr_episode,"num_interact",num_interact)             
